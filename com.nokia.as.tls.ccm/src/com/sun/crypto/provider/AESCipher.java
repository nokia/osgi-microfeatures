...
abstract class AESCipher extends CipherSpi {
    ...
    public static final class AES128_CCM_NoPadding extends OidImpl {
        public AES128_CCM_NoPadding() {
            super(16, "CCM", "NOPADDING");
        }
    }
    public static final class AES192_CCM_NoPadding extends OidImpl {
        public AES192_CCM_NoPadding() {
            super(24, "CCM", "NOPADDING");
        }
    }
    public static final class AES256_CCM_NoPadding extends OidImpl {
        public AES256_CCM_NoPadding() {
            super(32, "CCM", "NOPADDING");
        }
    }
    ...
    protected void engineUpdateAAD(byte[] src, int offset, int len) {
        if ( (core.getMode() == CipherCore.GCM_MODE || core.getMode() == CipherCore.CCM_MODE) && updateCalled) {
