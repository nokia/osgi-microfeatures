...
public class DiameterUtils {
    ...
    public static Charset ASCII = null;
    static {
	try{
    ...
    public static final Logger LOGGER_DIAMETER = Logger.getLogger ("as.diameter.lb.diameter");
    ...
    public static DiameterMessage updateDwa (DiameterMessage dwr, DiameterMessage dwa){
	return dwa.updateIdentifiers (dwr.getHopIdentifier (), dwr.getEndIdentifier ());
    }
