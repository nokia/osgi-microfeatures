...
/**
 * The interface to implement to handle Access Responses.
 */
public interface AccessResponseProxylet extends RadiusProxylet {
     ...
     */
    public int accept (AccessResponse response);
     ...
     */
    public int doResponse (AccessResponse response);
}
