...
public class DiameterMessage {
    ...
    private long _timestamp1 = 0L;
    private long _timestamp2 = 0L;
	...
	// timestamps are not cloned : useless
	return clone;
    }

    public DiameterMessage timestamp1 (long date){ _timestamp1 = date; return this;}
    public long timestamp1 (){ return _timestamp1;}
    public DiameterMessage timestamp2 (long date){ _timestamp2 = date; return this;}
    public long timestamp2 (){ return _timestamp2;}
    public byte[] timestamp1B (){
	byte[] bytes = new byte[7];
	bytes[0] = (byte)'T';
	bytes[1] = (byte) (_timestamp1 >> 40);
	bytes[2] = (byte) (_timestamp1 >> 32);
	bytes[3] = (byte) (_timestamp1 >> 24);
	bytes[4] = (byte) (_timestamp1 >> 16);
	bytes[5] = (byte) (_timestamp1 >> 8);
	bytes[6] = (byte) (_timestamp1);
	return bytes;
    }
    ...
    public boolean isProxiable (){ return ((_bytes[4] & 0x40) == 0x40); }
    public boolean isError (){ return ((_bytes[4] & 0x20) == 0x20); }
    public boolean isRetransmitted (){ return ((_bytes[4] & 0x10) == 0x10); }

    public DiameterMessage setError (){_bytes[4] = (byte) ((_bytes[4] & 0xFF) | 0x20); return this;}
