 ...
 *
 * @version 1.0
 * @see SFRS for License Management https://sharenet-ims.int.net.nokia.com/Download/394817326
 *
 */
public class StoredLicense extends AddnColumns implements Serializable {
     ...
     */
    private List<TargetSystem> targetIds;
    /**
    ...
    // Below are for NMS generated licenses.
     ...
     * @see FeatureInfo
     */
    public java.util.List<FeatureInfo> getFeatureInfoList() {
     ...
     * @see FeatureInfo
     */
    public void setFeatureInfoList(final List<FeatureInfo> featureInfoList) {
     ...
     */
    public List<TargetSystem> getTargetIds() {
     ...
     */
    public void setTargetIds(final List<TargetSystem> targetIds) {
    ...
    public void setLicenseMode(final LicenseMode licenseMode) {
    ...
    public boolean isNmsGenerated() {
        return this.originOMC != null && this.pool != null;
    }
}
