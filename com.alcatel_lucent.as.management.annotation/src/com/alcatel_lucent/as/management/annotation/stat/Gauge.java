...
/**
 * Annotates a method which returns a webadmin statistic counter, which always may increase or decrease.
 ...
 * 
 * <p> Here is a sample showing how a component may define a gauge:
 * <blockquote>
 * <pre>
 * &#64;Stat(rootSnmpName = "alcatel.srd.a5350.MyClass", rootOid = { 637, 71, 6, 3050 })
 * public class MyClass
 * {
 *     &#64;Gauge(snmpName="MySnmpShortName", oid=101, desc="MyCounter1 Description")
 ...
 * </pre>
 * </blockquote>
 * <p> Here is the above sample defining the same Gauge whose all instances values should be averaged :
 * <blockquote>
 * <pre>
 * &#64;Stat(rootSnmpName = "alcatel.srd.a5350.MyClass", rootOid = { 637, 71, 6, 3050 })
 * public class MyClass
 * {
 *     &#64;Gauge(snmpName="MySnmpShortName", oid=101, desc="MyCounter1 Description", consolidation = ConsolidationMode.AVERAGE )
 *     public int getMyGauge()
 *     {
 *         return 1;
 *     }
...
public @interface Gauge {
   ...
   * be applied on all instance values for this gauge. When present, the (blueprint) GUI will display
