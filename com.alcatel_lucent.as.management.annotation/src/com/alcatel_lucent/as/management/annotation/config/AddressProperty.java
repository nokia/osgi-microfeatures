...
/**
 * Annotates a String class field for a property name whose value is an Ip address (A.B.C.D).
 * 
 * <p> Here is a sample showing a proxylet defining an IP Address Property: 
 * 
 * <blockquote>
 * <pre>
 ...
 * {
 *     &#64;AddressProperty(title="My Address Property", 
 *                     required=true, 
 *                     defval="127.0.0.1")
...
public @interface AddressProperty {
  ...
  /**
   * Returns the GUI section name, when the property will be displayed. By default, the
   * section defined in {@link Config} is used.
   */
