...
/**
 * Annotates a String class field for a property name whose value is a boolean.
 * 
 * <p> Here is a sample showing a proxylet defining a Boolean Property: 
 * 
 * <blockquote>
 * <pre>
 ...
 * {
 *     &#64;BooleanProperty(title="My Address Property", required=true, defval=true)
...
public @interface BooleanProperty {
   ...
   */
  public boolean defval() default false;
