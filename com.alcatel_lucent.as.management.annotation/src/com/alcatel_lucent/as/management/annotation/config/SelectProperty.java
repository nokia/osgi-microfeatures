...
/**
 * Annotates a String class field for a property name whose value is in the range of some 
 * predefined values.
 *
 * <p> Here is a sample showing a proxylet defining a Select Property: 
 * 
 * <blockquote>
 * <pre>
 ...
 * {
 *     &#64;SelectProperty(title="My String Property", required=true, defval="1",
 *                      range={"1", "2", "3"})
