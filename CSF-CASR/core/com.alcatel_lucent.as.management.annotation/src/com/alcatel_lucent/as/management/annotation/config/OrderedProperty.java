...
/**
 * Annotates a String class field for a property name whose value may contain a list of values which can be ordered by the webadmin.
 *
 * <p> Here is a sample showing a proxylet defining a Ordered Property: 
 * 
 * <blockquote>
 * <pre>
 ...
 * {
 *     &#64;OrderedProperty(title="My String Property", required=true, defval="3 2 1",
 *                      range={"1", "2", "3"})
