...
@Component
@Property(name="type", value="socks4")
public class Socks4ChannelFilterFactory implements ChannelListenerFactory {
	...
	public TcpClientChannelListener createListener(TcpClientChannelListener listener, Map<?, Object> options) throws Exception {			
		return new Socks4TcpClientListener(listener, options, _wheelTimer);
	}
