...
public class TcpBasicLegacyTest1 extends IntegrationTestBase {
	...
	public static class Server implements TcpServerChannelListener {
		...
		void start() {
			...
			_reactor.start();
			_provider.newTcpServerChannel(new InetSocketAddress(8888), this, _reactor, null, _log);
		}
		...
		public void serverConnectionOpened(TcpServerChannel server) {
			_log.warn("server connection opened");
