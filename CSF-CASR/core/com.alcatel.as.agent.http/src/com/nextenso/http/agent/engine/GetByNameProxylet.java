...
public class GetByNameProxylet implements StreamedHttpRequestProxylet, StreamedHttpResponseProxylet {
  
  private DNSClient dnsClient = DNSClientFactory.newDNSClient();
  
  public GetByNameProxylet() {
  }
  ...
  public int doRequestHeaders(HttpRequestProlog prolog, HttpHeaders headers) throws ProxyletException {
    ...
    String[] dns = dnsClient.getHostByName(host);
