...
abstract class HandshakeContext implements ConnectionContext {
    ...
    // -- Export
    SecretKey                               exportSecret;
    public void setExportSecret(SecretKey exportSecret) {this.exportSecret = exportSecret;}
    public SecretKey getExportSecret() {return exportSecret;}
    public SSLSessionImpl exportToSession;
    // -- Export
