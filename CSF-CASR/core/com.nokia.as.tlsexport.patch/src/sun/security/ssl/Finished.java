    ...
    private static final
        ...
        private byte[] onProduceFinished(ServerHandshakeContext shc,
            ...
            try {
                ...
                // -- Export
                SSLKeyDerivation exportKD =
                        new SSLSecretDerivation(shc, masterSecret);
                SecretKey exportSecret = exportKD.deriveKey(
                        "TlsExporterMasterSecret", null);
                shc.setExportSecret(exportSecret);
                // -- Export
    ...
    private static final class T13FinishedConsumer implements SSLConsumer {
        ...
        private void onConsumeFinished(ClientHandshakeContext chc,
            ...
            try {
                ...
                SecretKey exportSecret = exportKD.deriveKey(
                        "TlsExporterMasterSecret", null);
                chc.setExportSecret(exportSecret);
                if (chc.exportToSession != null) {
                    chc.exportToSession.setExportKey(exportSecret);
                    chc.exportToSession = null;
                }
