 ...
 * CCM encryption, which is defined in RFC 5084 as follows:
 *
 * <pre>
...
public final class CCMParameters extends AlgorithmParametersSpi {
    ...
    protected void engineInit(AlgorithmParameterSpec paramSpec)
        ...
        CCMParameterSpec gps = (CCMParameterSpec) paramSpec;
...
//                  if ( tLen!=8 && tLen!=16 ) {
                    if (tLen!=4 && tLen!=6 && tLen!=8 && tLen!=10 && tLen!=12 && tLen!=14 && tLen!=16 ) {
...
//                tLen = 16;
    ...
    protected <T extends AlgorithmParameterSpec>
        ...
        if (CCMParameterSpec.class.isAssignableFrom(paramSpec)) {
            return paramSpec.cast(new CCMParameterSpec(tLen * 8, iv));
        } else {
            throw new InvalidParameterSpecException
                ("Inappropriate parameter specification");
        }
