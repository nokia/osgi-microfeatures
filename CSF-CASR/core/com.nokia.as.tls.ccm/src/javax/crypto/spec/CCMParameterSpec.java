 ...
 * Cipher Modes of Operation:  Counter Mode (CCM) and GMAC."
 * <p>
 * The CCM specification states that {@code tLen} may only have the
...
public class CCMParameterSpec implements AlgorithmParameterSpec {
    ...
    /**
     * Constructs a CCMParameterSpec using the specified authentication
     ...
     * or {@code src} is null.
     */
    public CCMParameterSpec(int tLen, byte[] src) {
        if (src == null) {
     ...
     */
    public CCMParameterSpec(int tLen, byte[] src, int offset, int len) {
