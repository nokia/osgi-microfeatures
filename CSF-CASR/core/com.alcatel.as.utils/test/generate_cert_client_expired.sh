...
#
#$JAVA_HOME/bin/keytool -genkey -keyalg rsa -keystore $TLS/client.ks -alias ccclient -validity 1 -startdate -2d <<EOF
$JAVA_HOME/bin/keytool -genkey -keyalg rsa -keystore $TLS/client.ks -alias ccclient -validity 1 -startdate "2015/10/03 00:00:00" <<EOF
password
password
client.alcatel.com 
Support Team
