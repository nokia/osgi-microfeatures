...
public interface RegisteredDomain {
    ...
    public static Optional<RegisteredDomain> from(String domain) {
        ...
        //XX: return Optional.ofNullable(sun.net.RegisteredDomain.registeredDomain(domain));
        return Optional.ofNullable(dtls.patch.sun2.RegisteredDomain.registeredDomain(domain));
    }
}
