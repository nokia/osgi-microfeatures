 ...
 *
 */
public abstract class MySunJSSE extends java.security.Provider {
    ...
    private MySunJSSE(java.security.Provider cryptoProvider,
            String providerName) {
