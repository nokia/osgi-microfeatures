 ...
 * 
 */
public class UpdateClientExpirationTime extends SimpleUpdate {
	private static final int ETAG = 1;
	...
	public UpdateClientExpirationTime(final Client client, final ClientTag clientTag, final Converter<Timestamp, DateTime> timestamp2DateTimeConverter) {
		super("update cls.clients set etag = ?, expires = ? where clientid = ?");
		this.client = client;
