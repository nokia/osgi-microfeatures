...
wait_str ../runtimes/udpclient/var/log/csf.runtime__component.instance/msg.log "Junit4Osgi: Tests done: passed: 1" 30
wait_str ../runtimes/udpserver/var/log/csf.runtime__component.instance/msg.log "Junit4Osgi: Tests done: passed: 1" 30
