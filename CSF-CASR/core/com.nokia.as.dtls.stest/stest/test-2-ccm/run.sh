...
wait_str ../runtimes/clientj11/var/log/csf.runtime__component.instance/msg.log "Junit4Osgi: Tests done: passed: 1" 30
wait_str ../runtimes/serverj11/var/log/csf.runtime__component.instance/msg.log "Junit4Osgi: Tests done: passed: 1" 30
