...
wait_str ../runtimes/client/var/log/csf.runtime__component.instance/msg.log "Junit4Osgi: Tests done: passed: 1" 30
wait_str ../runtimes/server/var/log/csf.runtime__component.instance/msg.log "Junit4Osgi: Tests done: passed: 1" 30
