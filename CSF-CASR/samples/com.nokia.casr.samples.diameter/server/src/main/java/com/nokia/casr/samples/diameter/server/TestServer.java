 ...
 */
@Component(property = "jmx.objectname=com.nokia.casr.samples.diameter:type=Server")
public class TestServer implements DiameterRequestProxylet, TestServerMBean {
	...
	public int doRequest(DiameterRequest request) {
		...
		System.out.println("***************** TestServer : doRequest : received request=" + request + ", count=" + _count);
