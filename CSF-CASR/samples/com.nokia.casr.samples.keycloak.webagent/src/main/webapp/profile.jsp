...
<%@page import="com.nokia.casr.samples.keycloak.vanilla.Controller" contentType="text/html" pageEncoding="ISO-8859-1" %>
<!DOCTYPE html>
<html>
<head>
...
<body>
<jsp:useBean id="controller" class="com.nokia.casr.samples.keycloak.vanilla.Controller" scope="request"/>
        ...
        <div id="profile-content" class="message">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><span id="username"><%=request.getUserPrincipal()%></span></td>
                </tr>
             </table>
        </div>
    </div>
