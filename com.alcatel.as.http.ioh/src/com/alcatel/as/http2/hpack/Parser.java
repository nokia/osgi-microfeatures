...
public final class Parser {
    ...
    final public void parse(In in, Out out) {
        int result;
        do {
            result = parse_one(in, out);
        } while (result != EOF);
    }

    final public int parse_one(In in, Out out) {
        int ret = EOF;
        switch (in.fetchByte()) {
    ...
    final public int parse_ff_1(In in, Out out) {
        int ret = EOF;
        // increase nb_bytes : 1
        switch (in.fetchByte()) {
    ...
    final public int parse_ff_2(In in, Out out) {
        int ret = EOF;
        // increase nb_bytes : 2
        switch (in.fetchByte()) {
    ...
    final public int parse_ff_3(In in, Out out) {
        int ret = EOF;
        // increase nb_bytes : 3
        switch (in.fetchByte()) {
