 ...
 * 
 */
public class QueryReservationsFeatureCodesForExpiredClients extends QueryReservationsFeatureCodes {
	...
	public QueryReservationsFeatureCodesForExpiredClients(final DateTime expires, final Converter<Timestamp, DateTime> timestamp2DateTimeConverter, Converter<License.Type, Integer> licenseType2IntegerConverter) {
		super("clientid in (select clientid from cls.clients where expires < ?) and type = ?");
