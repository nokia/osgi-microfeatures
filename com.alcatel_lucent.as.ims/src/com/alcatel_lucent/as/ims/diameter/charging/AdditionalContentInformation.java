...
/**
 * The Additional-Content-Information AVP wrapper.
 */
public class AdditionalContentInformation {
	 ...
	 */
	public AdditionalContentInformation(DiameterAVP avp, Version version) {
	...
	public DiameterAVP toAvp(Version version) {
		DiameterAVPDefinition def = ChargingUtils.getAdditionalContentInformationAVP(version);
		if (def == null) {
			return null;
		}
