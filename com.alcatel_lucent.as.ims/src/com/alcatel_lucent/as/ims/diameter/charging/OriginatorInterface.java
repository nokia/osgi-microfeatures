...
/**
 * 
 * The Originator-Interface AVP wrapper.
 */
public class OriginatorInterface {
	 ...
	 */
	public OriginatorInterface(DiameterAVP avp, Version version) {
	...
	public DiameterAVP toAvp(Version version) {
		DiameterAVPDefinition def = ChargingUtils.getOriginatorInterfaceAVP(version);
		if (def == null) {
			return null;
		}
