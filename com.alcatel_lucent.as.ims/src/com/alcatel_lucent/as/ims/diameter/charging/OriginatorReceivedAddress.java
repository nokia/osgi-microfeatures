...
/**
 * The Originator-Received-Address AVP wrapper.
 */
public class OriginatorReceivedAddress {
	 ...
	 */
	public OriginatorReceivedAddress(byte[] data, Version version) {
	 ...
	 * @param version The version of the 3GPP 32.299 document.
	 */
	public OriginatorReceivedAddress(DiameterAVP avp, Version version) {
	...
	public DiameterAVP toAvp(Version version) {
		DiameterAVPDefinition def = ChargingUtils.getOriginatorReceivedAddressAVP(version);
		if (def == null) {
			return null;
		}
